(function () {
    ...
    describe('app/expenses/expensesOfCategory', function () {
        ...
        var $rootScope, $location, $state, scope, $injector, $httpBackend, $q, ENV, AUTH_URLS, AccountModal, DatesUtils, InsightsService, INSIGHTS_URLS, EXPENSE_URLS, CATEGORY_URLS, STATES, AuthServiceMock, UserMock, $compile;
        ...
        beforeEach(function () {
            ...
            inject(function (_$rootScope_, _$state_, _$location_, _$injector_, _$httpBackend_, _$q_, _ENV_, _$compile_, _AccountModal_, _DatesUtils_, _InsightsService_, _INSIGHTS_URLS_, _EXPENSE_URLS_, _CATEGORY_URLS_, _STATES_, _AUTH_URLS_, $templateCache) {
        ...
        it('initial loads list if element is clicked', function () {
            var scope = _.extend($rootScope.$new(), {
                    totalPerCategory: {
                        "categoryDTO": {
                            "id": 31,
